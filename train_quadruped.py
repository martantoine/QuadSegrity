...
env_configs = {"force_max": 40.0,
               ...
               "force_cost_weight": 0.5,
               "switching_rate_cost_weight": 1.0,
               "total_timesteps": NSTEPS,
               "frame_skip": control_step_skip,
               } 
env = QuadrupedGymEnv(**env_configs, render_mode="human") 

# add a monitor wrapper to log the info generated by the step function. are you sure you are not missing anything ?
